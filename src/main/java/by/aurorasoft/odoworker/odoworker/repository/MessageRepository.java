...
public interface MessageRepository extends JpaRepository<Message, Long> {
    ...
    @Query(value = "SELECT id, datetime, latitude, longitude, altitude, speed, params, is_valid " +
    ...
    @Query(value = "SELECT id, datetime, latitude, longitude, altitude, speed, amount_satellite, course, params, is_valid " +
