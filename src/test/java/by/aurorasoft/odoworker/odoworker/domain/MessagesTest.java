...
class MessagesTest {
    ...
    void addParameter() {
        ...
        assertEquals("_odv:1000.0", given.getParams());
    }
    ...
    void addParameter2() {
        ...
        assertEquals("_odv:1000.1", given.getParams());
    }
    ...
    void addParameter4() {
        ...
        assertEquals("_odv:1000.2", given.getParams());
    }
    ...
    void addParameter5() {
        ...
        assertEquals("_odv:1000000000.0", given.getParams());
    }
    ...
    void addParameter6() {
        ...
        assertEquals("_odv:1000000000.2", given.getParams());
    }

    @Test
    void addParameterIfOneParam() {
        Message given = message(1L, "100:200");
        Messages.addAbsoluteOdo(given, 1000);
        assertEquals("100:200,_odv:1000.0", given.getParams());
    }

    @Test
    void addParameterIfTwoParam() {
        Message given = message(1L, "100:200,5:1");
        Messages.addAbsoluteOdo(given, 1000);
        assertEquals("100:200,5:1,_odv:1000.0", given.getParams());
    }
