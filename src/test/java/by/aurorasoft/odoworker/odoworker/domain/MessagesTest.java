...
class MessagesTest {
    ...
    void addParameter() {
        ...
        assertEquals("oda:1:1000.0", given.getParams());
    }
    ...
    void addParameter2() {
        ...
        assertEquals("oda:1:1000.1", given.getParams());
    }
    ...
    void addParameter4() {
        ...
        assertEquals("oda:1:1000.2", given.getParams());
    }
    ...
    void addParameter5() {
        ...
        assertEquals("oda:1:1000000000.0", given.getParams());
    }
    ...
    void addParameter6() {
        ...
        assertEquals("oda:1:1000000000.2", given.getParams());
    }
    ...
    void addParameterIfOneParam() {
        ...
        Messages.addAbsoluteOdo(given, 1000);
        assertEquals("100:1:200,oda:1:1000.0", given.getParams());
    }
    ...
    void addParameterIfTwoParam() {
        ...
        Messages.addAbsoluteOdo(given, 1000);
        assertEquals("100:1:200,5:1:1,oda:1:1000.0", given.getParams());
    }
